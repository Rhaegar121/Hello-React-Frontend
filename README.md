...
> This is a front end project for the "Hello World" project. You can find the back end API endpoint project here: [Hello Rails Back End](https://github.com/Rhaegar121/Hello-Rails-Backend)
...
```sh
  ...
  git clone https://github.com/Rhaegar121/Hello-React-Frontend
